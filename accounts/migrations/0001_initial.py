    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', models.CharField(max_length=15, validators=[django.core.validators.RegexValidator(message="Phone must start with '+' and have 12 numbers", regex='^\\+\\d{12}')])),
                ('address', models.CharField(blank=True, max_length=100, null=True)),
                ('profile_picture', models.ImageField(blank=True, null=True, upload_to='accounts_picture/')),
